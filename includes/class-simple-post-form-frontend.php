	...
	private function render_form( $form, $fields ) {
		...
		<div class="spf-form-container" id="<?php echo esc_attr( $form_id ); ?>">
			...
			<?php if ( ! empty( $form->enable_sender_copy ) && $form->enable_sender_copy == 1 ) : 
				$sender_copy_label = get_option( 'spf_sender_copy_label', '' );
				if ( empty( $sender_copy_label ) ) {
					$sender_copy_label = __( 'Send me a copy of this submission', 'simple-post-form' );
				}
			?>
				<div class="spf-form-group" style="margin-top: 15px;">
					<label style="display: flex; align-items: center; cursor: pointer;">
						...
						<span><?php echo esc_html( $sender_copy_label ); ?></span>
					</label>
				</div>
			<?php endif; ?>				<div class="spf-form-submit">
					<?php
